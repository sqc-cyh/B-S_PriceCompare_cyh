...
export default {
  ...
  data() {
    return {
      ...
      'https://gd-hbimg.huaban.com/5b5bccfaf3720f5ab107ee1ea86eec78bdefe62d10420-Lyb1Z9_fw658webp', // 替换为你的图片链接
      'https://m.360buyimg.com/babel/s1420x760_jfs/t1/196151/40/50733/100860/6736ad2dF86408dde/472cb2f6c60e6eea.jpg!q70.dpg', // 替换为你的图片链接
      'https://m.360buyimg.com/babel/jfs/t1/240737/29/22975/289012/67405c17F746d21c7/5c47765c68e58b6f.png', // 替换为你的图片链接
      ],
      featuredCategories: [
  ...
  methods: {
    ...
    navigateToPriceDown() {
    this.$router.push('/price_down'); // 确保名称与路由配置匹配
    },
  },
