...
<script>
import { ref, onMounted, watch, computed, beforeUnmount } from 'vue'
...
export default {
  ...
  setup() {
    ...
    beforeUnmount(() => {
      store.needSearch = true; // 在离开页面时设置 needSearch 为 true
    })
